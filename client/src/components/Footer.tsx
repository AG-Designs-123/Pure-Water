    ...
    <footer id="contact" className="bg-[#1a1a1a] text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h4 className="font-display font-bold text-lg mb-6 tracking-wide uppercase text-[#ccc]">Quick Links</h4>
            <ul className="space-y-4">
              <li><a href="#services" className="text-[#888] hover:text-white transition-colors">Services</a></li>
              <li><a href="#enquiry" className="text-[#888] hover:text-white transition-colors">Get a Quote</a></li>
              <li><a href="#payment" className="text-[#888] hover:text-white transition-colors">Pay Bill Online</a></li>
              <li><a href="#" className="text-[#888] hover:text-white transition-colors">Terms & Conditions</a></li>
            </ul>
          </div>

          <div>
            <h4 className="font-display font-bold text-lg mb-6 tracking-wide uppercase text-[#ccc]">Contact</h4>
        ...
        <div className="pt-8 border-t border-white/10 text-center text-[#555] text-sm">
